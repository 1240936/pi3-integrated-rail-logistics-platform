...
CREATE TABLE Route (
                       ...
                       EndFacilityID   number(10) NOT NULL,
                       PRIMARY KEY (ID));
CREATE TABLE Route_Train (
                             RouteID   number(10) NOT NULL,
                             TrainID   number(10) NOT NULL,
                             startDate date NOT NULL,
                             PRIMARY KEY (RouteID,
                                          TrainID),
                             CONSTRAINT UK_Route_Train_TrainID_StartDate
                                 UNIQUE (startDate, TrainID),
                             CONSTRAINT UK_Route_Train_RouteID_StartDate
                                 UNIQUE (RouteID, startDate));
CREATE TABLE Siding (
                        ID            number(10) NOT NULL,
...
ALTER TABLE Route_Train ADD CONSTRAINT FKRoute_Trai642166 FOREIGN KEY (RouteID) REFERENCES Route (ID);
ALTER TABLE Route_Train ADD CONSTRAINT FKRoute_Trai381883 FOREIGN KEY (TrainID) REFERENCES Train (ID);
