 ...
 * - Format: Uses format_command() assembly function (USAC04) to format commands
...
#include "serial_comm.h"  // For SerialPort structure
 ...
 * 
 * Uses format_command() assembly function (USAC04) to format the command
 ...
 * @param track_id Track number (0-99, as per format_command requirements)
