/*
 * Logging System - USAC12
 * 
 * Purpose: Record and export user actions
 * 
 * This file implements USAC12: "As an Administrator, I want to create a text
 * file (.txt file) with a sequence of actions performed by a specific user."
 */
