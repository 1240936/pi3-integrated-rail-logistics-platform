...
// NOTE: USAC01-09 assembly functions are implemented in assembly (.s files)
// and linked from ../../USAC01-09/sprint2/usac01-09/func1.o
// These functions are declared in asm.h and should NOT be implemented here.
// The assembly functions will be linked and used directly.
// 
// The following functions are provided by assembly code:
// - USAC01: encrypt_data() - Used in initialize.c
// - USAC02: decrypt_data() - Used in user_auth.c  
// - USAC03: extract_data() - Used in sensor_manager.c
// - USAC04: format_command() - Used in lightsigns_comm.c
// - USAC05: enqueue_value() - Used for sensor data circular buffers
// - USAC06: dequeue_value() - Used for sensor data circular buffers
// - USAC07: move_n_to_array() - Used for moving median filter
// - USAC08: sort_array() - Used for moving median filter
// - USAC09: median() - Used for moving median filter